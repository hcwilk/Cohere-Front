...
const BANNER_DATA = {
  title: 'Welcome to Cohere: The Cross-Parachain Arbitrage bot for the Polkadot Ecosystem',
  text:
    "By leveraging XCM Technology, we're able to identify arbitrage opportunities across the various parachains in Polkadot's environment",
  button: {
    link: '#',
    label: 'Get Token',
  },
