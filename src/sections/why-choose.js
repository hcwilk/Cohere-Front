...
const WHY_CHOOSE_DATA = {
  blockTitle: {
    title: 'Why you choose Cohere',
    text: "There's already a huge market of Crypto Trading bots. What makes us different?",
  },
  posts: [
    {
      icon: icon1,
      title: 'Historical Trade Success',
      text:
        '(Profitably fact, maybe from backtesting?)',
    },
    {
      icon: icon2,
      title: 'Secure',
      text:
        "This is probably where we'd post an audit of some sort",
    },
    {
      icon: icon3,
